...
/**
 * @fileOverview A flow to summarize chat history for users.
 *
...
const SummarizeChatHistoryInputSchema = z.object({
  chatHistory: z
    .string()
    .describe('The complete chat history to generate the summary from.'),
});
...
const SummarizeChatHistoryOutputSchema = z.object({
  summary: z.string().describe('The generated summary for the chat history.'),
});
